...
export class FacturasComponent implements OnInit {
  ...
  trackId = (_index: number, item: IFacturas): number => this.facturasService.getFacturasIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.facturas = this.refineData(dataFromBody);
  }

  protected refineData(data: IFacturas[]): IFacturas[] {
    return data.sort(this.sortService.startSort(this.predicate, this.ascending ? 1 : -1));
  }

  protected fillComponentAttributesFromResponseBody(data: IFacturas[] | null): IFacturas[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.facturasService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
