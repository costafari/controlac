...
describe('Detalles Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'detalles', component: DetallesComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to detallesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDetallesIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDetallesIdentifier).toHaveBeenCalledWith(entity);
