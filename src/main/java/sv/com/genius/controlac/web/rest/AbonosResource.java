...
public class AbonosResource {
    ...
    public ResponseEntity<Abonos> updateAbonos(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, abonos.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Abonos> partialUpdateAbonos(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, abonos.getId().toString())
        );
    }
