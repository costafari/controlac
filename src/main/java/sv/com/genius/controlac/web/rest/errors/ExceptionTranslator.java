...
import sv.com.genius.controlac.service.EmailAlreadyUsedException;
import sv.com.genius.controlac.service.UsernameAlreadyUsedException;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        ...
        if (
            ex instanceof sv.com.genius.controlac.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "sv.com.genius.controlac");
    }
}
